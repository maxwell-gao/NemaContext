...
\begin{center}
\includegraphics[width=0.7\textwidth]{figures/context_levels.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\textwidth]{figures/lineage_tree.pdf}
\end{center}
\end{columns}
\end{frame}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{figures/trimodal_integration.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{figures/temporal_gap.pdf}
\end{center}
...
\vspace{1.5em}
\textbf{Our Question}:\\
Can we \textbf{infer} spatial context from lineage + molecular context?
...
\column{0.48\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{figures/gnn_problem.pdf}
\end{center}
\end{columns}
\end{frame}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{figures/transformer_context.pdf}
\end{center}
...
\column{0.42\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{figures/flow_matching.pdf}
\end{center}
\end{columns}
\end{frame}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{figures/curriculum.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{figures/synthesis.pdf}
\end{center}
