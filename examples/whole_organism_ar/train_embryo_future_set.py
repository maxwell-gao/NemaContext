...
def parse_args():
    ...
    p.add_argument("--latent_set_weight", type=float, default=0.2)
    ...
    p.add_argument("--decoded_gene_weight", type=float, default=0.05)
    p.add_argument("--decoded_spatial_weight", type=float, default=0.005)
